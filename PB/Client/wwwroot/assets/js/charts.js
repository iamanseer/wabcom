...
//function chartdonut(item) {
//    var series = [];
//    var labels = [];
//    var colours = ['#14B8A6', '#F59E0B', '#90A0F3'];
//    for (var i = 0; i < item.length; ++i) {
//        series.push(item[i].dataCount);
//        labels.push(item[i].fieldName);
//    }
//    var chart = c3.generate({
//        bindto: '#chart-donut',// id of chart wrapper
//        data: {
...
//    //var chart = new c3.generate(document.querySelector("#chart-donut"), data);
//    //chart.render();
//}
...
//        series.push(item[i].dataCount);
//        labels.push(item[i].fieldName);
//        colors.push('#' + item[i].color); // Remove the '#' from the color code
//    }

//    var chartData = [];
//    for (var i = 0; i < series.length; i++) {
//        chartData.push([labels[i], series[i]]);
//    }
...
//        },
//        color: {
//            pattern: colors // Set the colors using the extracted array
//        },
//        legend: {
//            show: false
//        },
...
function chartpie(item) {
    ...
    for (var i = 0; i < item.length; ++i) {
        series.push(item[i].dataCount);
        labels.push(item[i].fieldName);
        colors.push(item[i].color); // Use the color property directly
    }
...
function barchart(data) {
    ...
    var length = item.months.length;

    for (var i = 0; i < length; i++) {
        months.push(item.months[i]);
        totalCounts.push(item.totalEnquiryCounts[i]);
        newCounts.push(item.newEnquiryCounts[i]);
        followupCounts.push(item.inFollowupEnquiryCounts[i]);
        businessCounts.push(item.inBusinessEnquiryCounts[i]);
        closedCounts.push(item.inClosedEnquiryCount[i]);
    }
    ...
    var chart = c3.generate({
        ...
        data: {
            columns: [
                ['data1'].concat(totalCounts),
                ['data2'].concat(newCounts),
                ['data3'].concat(followupCounts),
                ['data4'].concat(businessCounts),
                ['data5'].concat(closedCounts)
            ],
            type: 'bar', // default type of chart
            colors: {
                data1: '#d6cffa',
